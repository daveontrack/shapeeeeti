...
const values = [
  {
    ...
    title: "Our Mission",
    description:
      "To educate and support vulnerable children, empower women, and strengthen communities to break the cycle of poverty, hunger, illiteracy, and disease while fostering dignity, hope, and opportunity.",
  },
  {
    icon: Eye,
    title: "Our Vision",
    description:
      "A future where all people in Ethiopia live healthy, happy, productive, and dignified lives, with access to education, healthcare, clean water, and economic empowerment.",
  },
  {
    icon: Gem,
    title: "Our Core Values",
    description:
      "Accountability, responsibility, transparency, integrity, equity, respect, collaboration, participation, hard work, courage, and compassion guide every action and program we undertake.",
  },
]
